"""Recherche B6 des carrés magiques exacts 9/9 en boîte complète."""
...
def main() -> int:
    ...
    stem = f"lo_shu_b6_exact9_{args.catalog_mode}_box_R{args.complete_box_root}"
    ...
    fieldnames = [
        "parameter_A", "q", "r", "primitive_root_gcd", "shared_square",
