"""Recherche B5 de toutes les orbites D4 exactement 8/9 en boîte complète."""
...
def main() -> int:
    ...
    if args.catalog_mode == "material":
        ...
        result = search_lo_shu_eight_box(
            args.complete_box_root,
        ...
        search_started = time.perf_counter()
        result = search_lo_shu_eight_incidence_groups(
            args.complete_box_root,
            stream,
            primitive_only=not args.all_scalings,
            square_membership_mode=args.square_membership,
    ...
    stem = f"lo_shu_b5_exact8_{args.catalog_mode}_box_R{args.complete_box_root}"
