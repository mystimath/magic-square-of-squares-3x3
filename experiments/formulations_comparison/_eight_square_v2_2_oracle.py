"""Adaptateur exhaustif à petite borne pour contrôler B5 contre v2.2 SAFE."""
...
from prototypes.eight_square_masks import mask_orbit
...
def search_v2_2_eight_box(
    ...
    *,
    ...
    """Exécute les chemins exact8 et relaxed7 sans sélection de centres."""
    ...
    for center, offsets in sorted(offsets_by_center.items()):
        ...
        for candidate in candidates:
            ...
            if not report.accepted or report.square_count != 8:
