...
Cette variante autorise aussi --min-total 6 en mode relaxed7
pour produire des exemples exploratoires 6/9 avec centre non carré.
...
def main() -> None:
    ...
    if args.search_mode == "relaxed7" and args.min_total < 6:
        parser.error("Pour relaxed7, --min-total doit être >= 6 dans cette variante exploratoire.")
    if args.search_mode == "relaxed7" and args.min_total == 6:
        print("[Info] relaxed7 avec min-total = 6 : mode exploratoire 6/9, non exhaustif pour les résultats principaux.")
